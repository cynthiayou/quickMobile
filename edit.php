      ...
      <div class="row">
        ...
        <div class="col-md-6 mx-auto">
          <div class="card h-110">
            ...
            <div class="card-body">
              <form action="productEdit.php?product_id=<?php echo $product_id ?>" id="login-form" role="form" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="title">Title</label>
                  <input type="text" name="title" id="title" class="form-control" value="<?php echo $product_title ?>">
                </div>
                <div class="form-group">
                  <label for="manufacture">Manufacture</label>
                  <input type="text" name="manufacture" id="manufacture" class="form-control" value="<?php echo $product_manufacture ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="color" id="color" class="form-control" value="<?php echo $product_color ?>">
                </div>
                <div class="form-group">
                  <label for="capacity">Capacity</label>
                  <input type="text" name="capacity" id="capacity" class="form-control" value="<?php echo $product_capacity ?>">
                </div>
                  <div class="form-group">
                      <label for="inventory">Inventory</label>
                      <input type="text" name="inventory" id="inventory" class="form-control" value="<?php echo $inventory ?>">
                  </div>
                <div class="form-group">
